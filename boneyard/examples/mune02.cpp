/*
 * Use an STK instrument to synthesize a sound and play it in realtime
 * using RtAudio.
 *
 * This is a copy of stk-4.4.4/projects/examples/bethree.cpp (perhaps
 * modified), since our only goal today is to make sure we can compile
 * and run files using the STK library.
 */
