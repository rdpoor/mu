...
int main() {
  ...
  multiply_stream.removeAllSources();
  multiply_stream.step(buffer, 0, player);
  ...
  ASSERT(multiply_stream.getStart()==mu::kIndefinite);
  ASSERT(multiply_stream.getEnd()==mu::kIndefinite);

  // ================================================================
  fprintf(stderr, "=== stream1 only\n");
  multiply_stream.removeAllSources();
  multiply_stream.addSource(stream1);
  multiply_stream.step(buffer, 0, player);
  ...
  multiply_stream.removeAllSources();
  multiply_stream.addSource(stream2);
  multiply_stream.step(buffer, 0, player);
  ...
  ASSERT(multiply_stream.getStart() == 0);
  ASSERT(multiply_stream.getEnd() == 8);

  // ================================================================
  fprintf(stderr, "=== stream3 only\n");
  multiply_stream.removeAllSources();
  multiply_stream.addSource(stream3);
  multiply_stream.step(buffer, 0, player);
  ...
  ASSERT(multiply_stream.getStart() == 6);
  ASSERT(multiply_stream.getEnd() == 14);

  // ================================================================
  fprintf(stderr, "=== stream4 only\n");
  multiply_stream.removeAllSources();
  multiply_stream.addSource(stream4);
  multiply_stream.step(buffer, 0, player);
  ...
  ASSERT(multiply_stream.getStart() == 12);
  ASSERT(multiply_stream.getEnd() == 20);
