...
int main() {
  ...
  add_sp.removeAllSources();
  add_sp.step(buffer, 0, true);
  ...
  ASSERT(add_sp.getStart()==mu::TickUtils::indefinite());
  ASSERT(add_sp.getEnd()==mu::TickUtils::indefinite());

  // ================================================================
  fprintf(stderr, "=== stream1 only\n");
  add_sp.removeAllSources();
  add_sp.addSource(stream1);
  add_sp.step(buffer, 0, true);
  ...
  ASSERT(add_sp.getStart() == 0);
  ASSERT(add_sp.getEnd() == 8);

  // ================================================================
  fprintf(stderr, "=== stream3 only\n");
  add_sp.removeAllSources();
  add_sp.addSource(stream3);
  add_sp.step(buffer, 0, true);
  ...
  ASSERT(add_sp.getStart() == 6);
  ASSERT(add_sp.getEnd() == 14);

  // ================================================================
  fprintf(stderr, "=== stream4 only\n");
  add_sp.removeAllSources();
  add_sp.addSource(stream4);
  add_sp.step(buffer, 0, true);
  ...
  ASSERT(add_sp.getStart() == 12);
  ASSERT(add_sp.getEnd() == 20);
