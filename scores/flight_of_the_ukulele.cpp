...
int main() {
  ...
  left_hand.chord(dur_e, "a2", "e3", "c4", "", "", staccato, rolled_chord);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "f3", "a3", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "e4", legato);
  right_hand.note(dur_s, "ef4", legato);
  right_hand.note(dur_s, "d4", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "e3", "a3", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "d3", "e3", "gs3", "b3", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "c4", legato);
  right_hand.note(dur_s, "cs4", legato);
  right_hand.note(dur_s, "d4", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "c3", "e3", "a3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "f3", "a3", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "e4", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "cs3", "g3", "a3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "d3", "f3", "a3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "af4", legato);
  right_hand.note(dur_s, "g4", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "f3", "a3", "d4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "d3", "g3", "b3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "af4", legato);
  right_hand.note(dur_s, "g4", legato);
  ...
  left_hand.chord(dur_e, "f3", "a3", "d4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "g3", "bf3", "d4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "af4", legato);
  right_hand.note(dur_s, "g4", legato);
  ...
  left_hand.chord(dur_e, "f3", "a3", "d4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "e3", "g3", "a3", "cs4", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "f4", legato);
  right_hand.note(dur_s, "fs4", legato);
  right_hand.note(dur_s, "g4", legato);
  ...
  left_hand.chord(dur_e, "f3", "a3", "d4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "d3", "g3", "bf3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "af4", legato);
  right_hand.note(dur_s, "g4", legato);
  ...
  left_hand.chord(dur_e, "d3", "f3", "a3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "cs3", "e3", "g3", "a3", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "f4", legato);
  right_hand.note(dur_s, "fs4", legato);
  right_hand.note(dur_s, "g4", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_s, "d3", "f3", "", "", "", 2.0, short_arpeggio); // 2x legato
  ...
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "af3", "bf3", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "bf4", legato);
  right_hand.note(dur_s, "a4", legato);
  ...
  left_hand.chord(dur_e, "af3", "", "", "", "", staccato, short_arpeggio);
  left_hand.chord(dur_e, "af3", "bf3", "", "", "", staccato, short_arpeggio);
  left_hand.chord(dur_e, "g3", "b3", "", "", "", staccato, short_arpeggio);
  left_hand.chord(dur_e, "fs3", "c4", "", "", "", staccato, short_arpeggio);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "bf4", legato);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "gs4", legato);
  ...
  left_hand.chord(dur_h * 2, "f3", "cs4", "", "", "", staccato, short_arpeggio);
  right_hand.note(dur_s, "a4", legato);
  ...
  left_hand.note(dur_s, "ef4", legato);
  left_hand.note(dur_s, "df4", legato);
  right_hand.chord(dur_h, "df5", "ef5", "", "", "", legato, short_arpeggio);
  ...
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "df4", "ef4", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "d5", legato);
  right_hand.note(dur_s, "ef5", legato);
  right_hand.note(dur_s, "d5", legato);
  ...
  dynamics.ramp(dur_h, dyn_pp);
  left_hand.chord(dur_e, "d4", "", "", "", "", staccato, short_arpeggio);
  left_hand.chord(dur_e, "df4", "ef4", "", "", "", staccato, short_arpeggio);
  left_hand.chord(dur_e, "c4", "e4", "", "", "", staccato, short_arpeggio);
  left_hand.chord(dur_e, "b3", "f4", "", "", "", staccato, short_arpeggio);
  right_hand.note(dur_s, "d5", legato);
  right_hand.note(dur_s, "ef5", legato);
  right_hand.note(dur_s, "d5", legato);
  right_hand.note(dur_s, "cs5", legato);
  ...
  dynamics.set(dur_h, dyn_mf);
  left_hand.chord(dur_h * 2, "bf3", "fs4", "", "", "", staccato, short_arpeggio);
  right_hand.note(dur_s, "d5", legato);
  ...
  dynamics.set(dur_h, dyn_pp);
  left_hand.chord(dur_e, "bf3", "d4", "g4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e + dur_q);
  right_hand.note(dur_s, "d5", legato);
  right_hand.note(dur_s, "cs5", legato);
  right_hand.note(dur_s, "c5", legato);
  ...
  left_hand.chord(dur_e, "bf3", "d4", "g4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "c4", "ef4", "g4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "d5", legato);
  right_hand.note(dur_s, "cs5", legato);
  right_hand.note(dur_s, "c5", legato);
  ...
  left_hand.chord(dur_e, "bf3", "d4", "g4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "fs3", "c4", "ef4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "d5", legato);
  right_hand.note(dur_s, "cs5", legato);
  right_hand.note(dur_s, "c5", legato);
  ...
  dynamics.set(dur_h, dyn_mf);
  left_hand.chord(dur_e, "e3", "gs3", "e4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e + dur_q);
  right_hand.note(dur_s, "e6", legato);
  right_hand.note(dur_s, "ef6", legato);
  right_hand.note(dur_s, "d6", legato);
  ...
  left_hand.chord(dur_e, "a3", "e4", "c5", "", "", staccato, rolled_chord);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "f4", "a4", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "e5", legato);
  right_hand.note(dur_s, "ef5", legato);
  right_hand.note(dur_s, "d5", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "e4", "a4", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "d4", "e4", "gs4", "b4", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "c5", legato);
  right_hand.note(dur_s, "cs5", legato);
  right_hand.note(dur_s, "d5", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "c4", "e4", "a4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "f4", "a4", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "e5", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "cs4", "g4", "a4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "d4", "f4", "a4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a5", legato);
  right_hand.note(dur_s, "af5", legato);
  right_hand.note(dur_s, "g5", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "f4", "a4", "d5", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "d4", "g4", "b4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a5", legato);
  right_hand.note(dur_s, "af5", legato);
  right_hand.note(dur_s, "g5", legato);
  ...
  left_hand.chord(dur_e, "f4", "a4", "d5", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "g4", "bf4", "d5", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a5", legato);
  right_hand.note(dur_s, "af5", legato);
  right_hand.note(dur_s, "g5", legato);
  ...
  left_hand.chord(dur_e, "f4", "a4", "d5", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "e4", "g4", "a5", "cs5", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "f5", legato);
  right_hand.note(dur_s, "fs5", legato);
  right_hand.note(dur_s, "g5", legato);
  ...
  dynamics.ramp(dur_h, dyn_pp);
  left_hand.chord(dur_e, "e3", "a3", "c4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "e3", "gs3", "b3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a5", legato);
  right_hand.note(dur_s, "b5", legato);
  right_hand.note(dur_s, "c6", legato);
  ...
  dynamics.set(dur_h, dyn_f);
  left_hand.chord(dur_e, "a2", "e3", "", "", "", staccato, short_arpeggio);
  left_hand.chord(dur_e, "e3", "c4", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_q);
  right_hand.note(dur_s, "e6", legato);
  right_hand.note(dur_s, "ef6", legato);
  right_hand.note(dur_s, "d6", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "a3", "c4", "e4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "fs3", "a3", "d4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "e6", legato);
  right_hand.note(dur_s, "ef6", legato);
  right_hand.note(dur_s, "d6", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "e3", "gs3", "d4", "e4", "", staccato, short_arpeggio);
  left_hand.rest(dur_e + dur_q);
  right_hand.note(dur_s, "e6", legato);
  right_hand.note(dur_s, "f6", legato);
  right_hand.note(dur_s, "e6", legato);
  ...
  left_hand.chord(dur_e, "a3", "e4", "c5", "", "", staccato, rolled_chord);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "a3", "cs4", "g4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "a3", "d4", "f4", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e + dur_q);
  right_hand.note(dur_s, "f6", legato);
  right_hand.note(dur_s, "e6", legato);
  right_hand.note(dur_s, "ef6", legato);
  ...
  left_hand.chord(dur_e, "a2", "e3", "c4", "", "", staccato, rolled_chord);
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "a2", "cs3", "g3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a5", legato);
  right_hand.note(dur_s, "af5", legato);
  right_hand.note(dur_s, "g5", legato);
  ...
  dynamics.rest(dur_h);
  left_hand.chord(dur_e, "a2", "d3", "f3", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e + dur_q);
  right_hand.note(dur_s, "f5", legato);
  right_hand.note(dur_s, "e5", legato);
  right_hand.note(dur_s, "ef5", legato);
  ...
  left_hand.rest(dur_e);
  left_hand.chord(dur_e, "gs3", "bf3", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e);
  right_hand.note(dur_s, "a4", legato);
  right_hand.note(dur_s, "bf4", legato);
  right_hand.note(dur_s, "a4", legato);
  ...
  left_hand.note(dur_s, "e4", legato);
  right_hand.chord(dur_e, "e5", "", "", "", "", staccato, short_arpeggio);
  right_hand.chord(dur_e, "e5", "fs5", "", "", "", staccato, short_arpeggio);
  right_hand.chord(dur_e, "e5", "g5", "", "", "", staccato, short_arpeggio);
  right_hand.chord(dur_e, "d5", "gs5", "", "", "", staccato, short_arpeggio);
  ...
  left_hand.rest(dur_q);
  right_hand.chord(dur_q, "c5", "a5", "", "", "", staccato, short_arpeggio);
  right_hand.note(dur_s, "e4", legato);
  right_hand.note(dur_s, "f4", legato);
  right_hand.note(dur_s, "fs4", legato);
  right_hand.note(dur_s, "g4", legato);
  ...
  left_hand.chord(dur_e, "a1", "a2", "", "", "", staccato, short_arpeggio);
  left_hand.rest(dur_e + dur_q);
